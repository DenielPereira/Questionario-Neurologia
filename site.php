...
<body>
    ...
    <div class="center">
        <button class="btn_sair" onClick="window.location.href = 'login.html'">sair</button>
        <button class="btn_continuar" onClick="window.location.href = 'perguntas.html'">continuar</button>
    </div>
</body>
